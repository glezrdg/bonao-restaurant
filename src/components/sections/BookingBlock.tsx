  ...
  return (
    <div className="relative">
      ...
      >
        ...
        {/* Reservation Widget - Below */}
        {showResyWidget && (
          <motion.div
            variants={fadeInUp}
            className="bg-charcoal/50 backdrop-blur-sm border border-line-dark rounded-xl p-8"
          >
            <h3 className="font-garamond text-2xl text-paper mb-6 text-center">
              Book a Table
            </h3>
            <ResyWidget />
            <p className="text-sm text-greige mt-6 text-center">
              Or call us at{" "}
              <a
        ...
        {showPrivateDiningCTA && (
          <motion.div variants={staggerItem} className="border-t border-line-dark pt-8 mt-12 text-center">
